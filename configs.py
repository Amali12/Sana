...
STREAM_LOGS = environ.get('STREAM_LOGS','-1001948460298')
SESSION = environ.get('SESSION','MissRozy')
CUSTOM_CAPTION = environ.get('CUSTOM_CAPTION')


class Config(object):
	API_ID = int(os.environ.get("API_ID", 27471124))
	API_HASH = os.environ.get("API_HASH", "8374fb424fd0408372838a2bb23ec441")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6658642988:AAHubGCDJa5tkJaSIww1axPbL5KSUe5qlC0")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "SanaQueenBot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1001748321363))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "1766843956"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://redbeastorg:Newarz22@cluster0.vsla55d.mongodb.net/?retryWrites=true&w=majority")
	...
	LAZY_PIC = os.environ.get("LAZY_PIC","https://telegra.ph/file/7711f8cce893657176f74.png")
